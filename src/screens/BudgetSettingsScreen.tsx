  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        <Text style={styles.subtitle}>Choose your preferred travel budget level</Text>
        {OPTIONS.map(opt => {
            ...
            >
              ...
              <View style={styles.info}>
                <View style={styles.labelRow}>
                  ...
                  <Text style={[styles.price, { color: opt.color }]}>{opt.price}</Text>
                </View>
...
const makeStyles = (colors: AppColors) => StyleSheet.create({
  ...
  iconWrap: { width: wScale(48), height: wScale(48), borderRadius: wScale(14), alignItems: 'center', justifyContent: 'center' },
  info: { flex: 1 },
  labelRow: { flexDirection: 'row', alignItems: 'center', gap: wScale(8), marginBottom: hScale(3) },
  label: { fontSize: wScale(15), fontFamily: Fonts.plusJakartaSansBold, color: colors.textPrimary },
  price: { fontSize: wScale(13), fontFamily: Fonts.plusJakartaSansBold },
